 ...
 */
function puskar_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function puskar_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function puskar_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('puskar_sanitize_number')) :
    function puskar_sanitize_number($input)
    {
 ...
 *
 */
if (!function_exists('puskar_sanitize_image')) :
    function puskar_sanitize_image($image, $setting)
    {
        /*
